...
The first useful rendering checkpoint was U01c: the centre sector visibly demonstrates the biome-plus-transparent-overlay model with forest, town, and built-facility examples. The camera core is operational. U01di is complete; U01dii is next, followed by the interaction remainder of U01e.
